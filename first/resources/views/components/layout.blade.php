        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-8" src="https://assets.laracasts.com/images/primary-logo-symbol.svg" alt="Laracasts">
                    </div>
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="size-8 rounded-full" src="https://assets.laracasts.com/images/mascot/larywink.svg" alt="">
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://assets.laracasts.com/images/mascot/larywink.svg" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Lary Robot</div>
                        <div class="text-sm font-medium text-gray-400">larysgotamail@gmail.com</div>
                    </div>
